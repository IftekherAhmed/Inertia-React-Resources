<nav class="col-md-3 col-lg-2 d-md-block sidebar">
    <div class="sidebar-section">
        <div class="sidebar-heading">Project Structure</div>
    ...
    <div class="sidebar-section">
        <div class="sidebar-heading">Database Layer</div>
        <ul class="nav flex-column">
            <li class="nav-item">
    ...
    <div class="sidebar-section">
        <div class="sidebar-heading">Backend Implementation</div>
        <ul class="nav flex-column">
            <li class="nav-item">
